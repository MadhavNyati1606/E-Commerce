...
const CartItems = ({item}) => {
    const {removeFromCart, clearCart, increaseCart, decreaseCart} = useContext(CartContext);
            ...
            <div className="w-full min-h-[150px] flex items-center gap-x-4">
                ...
                <div  className='w-full flex flex-col'> 
                    ...
                    <div className='flex flex-1 max-w-[100px]   items-center h-full border text-primary font-medium'>
                        <div className='flex-1 cursor-pointer h-full flex justify-center items-center' onClick={()=> decreaseCart(id)}>
                        <IoMdRemove/>
                        </div>
                        <div className='h-full flex justify-center items-center px-2 '>
                            {amount}
                        </div>
                        <div className='flex-1 h-full flex justify-center items-center cursor-pointer' onClick={()=> increaseCart(id)}>
                            <IoMdAdd/>
                        </div>
                    </div>
